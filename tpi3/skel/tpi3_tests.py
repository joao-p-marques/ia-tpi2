...
bn.add('c_s',[('c_c',True),('s_t',True),('s_q',True ),('f_s',True )],0.091)
bn.add('c_s',[('c_c',True),('s_t',True),('s_q',True ),('f_s',False )],0.081)
bn.add('c_s',[('c_c',True),('s_t',True),('s_q',False ),('f_s',True )],0.045)
bn.add('c_s',[('c_c',True),('s_t',True),('s_q',False ),('f_s',False )],0.065)
bn.add('c_s',[('c_c',True),('s_t',False),('s_q',True ),('f_s',True)],0.087)
bn.add('c_s',[('c_c',True),('s_t',False),('s_q',True),('f_s',False )],0.043)
bn.add('c_s',[('c_c',True),('s_t',False),('s_q',False ),('f_s',True)],0.035)
bn.add('c_s',[('c_c',True),('s_t',False),('s_q',False),('f_s',False )],0.067)
bn.add('c_s',[('c_c',False),('s_t',True),('s_q',True),('f_s',True)],0.052)
bn.add('c_s',[('c_c',False),('s_t',True),('s_q',True),('f_s',False)],0.054)
bn.add('c_s',[('c_c',False),('s_t',True),('s_q',False),('f_s',True)],0.056)
bn.add('c_s',[('c_c',False),('s_t',True),('s_q',False),('f_s',False)],0.078)
bn.add('c_s',[('c_c',False),('s_t',False),('s_q',True),('f_s',True )],0.045)
bn.add('c_s',[('c_c',False),('s_t',False),('s_q',True),('f_s',False)],0.031)
bn.add('c_s',[('c_c',False),('s_t',False),('s_q',False),('f_s',True )],0.034)
bn.add('c_s',[('c_c',False),('s_t',False),('s_q',False),('f_s',False)],0.023)
